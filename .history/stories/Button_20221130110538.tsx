...
    ...props
    ...
    const mode = scent ? 'button--svg' : 'storybook-button--secondary';
    return (
    <>
        <button
            type="button"
            ...
            >
                ...
                <path id="bottle__path"
                    fill="orange"
                    d="M307.112,175.072c-10.75-3.962-17.886-14.213-17.886-25.652V81.455h1.122 c6.545,0,12.225-4.507,13.713-10.876l12.098-51.399c0.996-4.201,0-8.614-2.664-11.981c-2.678-3.385-6.738-5.341-11.053-5.341  
                    ...
                    mask='url(#gradient-mask)'></path>
            </svg>

            <span className="button--svg__label">Chimonanthus or Wintersweet</span>
        </button>
    </>
    );
};