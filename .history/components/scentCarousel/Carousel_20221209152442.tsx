...
export const InteractiveMarquee = ({
    ...
    useEffect(() => {
        isCarouselToggled ? marquee.current.classList.add("open") : marquee.current.classList.remove("open")
        // console.log(carouselList.current)
    }, [isCarouselToggled])
    ...
    return (
        <>
            ...
            >
                { !isCarouselToggled ? 
                    <CarouselList content = { children } speed = { speed } /> : += <CarouselList content = {children} speed = { speed } />
                        {/* <CarouselList content = {children} speed = { speed } /> */}
                    // carouselListClass = {`${isCarouselToggled ? styles.carouselToggled : ''}`}
                }
