...
export const CarouselList = ({ 
    ...
    const setXAxisContentPosition = () => {
        ...
        console.log('insideee loop')
        carouselList.current.style.transform = `translate3d(${xAxisContentPositionPercentage}%, 0, 0)`
    };

    const setToggledPosition = () => {
        carouselList.current.style.transform = `translate3d(0%, 0, 0)`
    }
    ...
    useRafLoop(isCarouselToggled ? loop : setToggledPosition, true)
