...
export const ScentImage = ({
    ...
    return (
            <svg 
                ...
                <filter id='noiseFilter' x="-10%" y="-10%" width="120%" height="120%" result="noise">
                    <feTurbulence 
                        type='turbulence' 
                        ...
                        stitchTiles='stitch'
                    />
                    <feDiffuseLighting in="noise" lighting-color="hsl(39, 33%, 94%)" surfaceScale="4">
                        <feDistantLight id="distLight" azimuth="121" elevation="79"></feDistantLight>
                    </feDiffuseLighting>
                </filter>
