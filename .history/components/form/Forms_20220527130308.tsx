...
export const Form = ({
    ...
    return (
        <form name = { name }
            ...
            <label htmlFor="telephone-input">Telephone Input</label>
            <input className="input" id="telephone-input" type="tel" inputMode='tel' autoComplete='tel'/>
            <label htmlFor="email-input">Email Input</label>
            <input className="input" id="email-input" type="email" inputMode='email'/>
            <label htmlFor="password-input">Password Input</label>
            <input className="input" id="password-input" type="password" autoComplete='password'/>
