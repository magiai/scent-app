...
export const Form = ({
    ...
    return (
        <form name = { name }
            method = { method }
            className = { className }>
            {/* each input should have an id and  and label assigned to it */}
            <label className = { styles.label } htmlFor="text-input">Text Input</label>
            <input className = { styles.input } id="text-input" type="text" inputMode='text'required/>
            <label className = { styles.label } htmlFor="number-input">Number Input</label>
            <input className = { styles.input } id="number-input" type="number" inputMode='numeric'/>
            <label className = { styles.label } htmlFor="telephone-input">Telephone Input</label>
            <input className = { styles.input } id="telephone-input" type="tel" inputMode='tel' autoComplete='tel'/>
            <label className = { styles.label } htmlFor="email-input">Email Input</label>
            <input className = { styles.input } id="email-input" type="email" inputMode='email' autoComplete='email'/>
            <label className = { styles.label } htmlFor="password-input">Password Input</label>
            <input className = { styles.input } id="password-input" type="password" autoComplete='current-password'/>
            <label className = { styles.label } htmlFor="url-input">Url Input</label>
            <input className = { styles.input } id="url-input" type="url" inputMode='url' autoComplete='url'/>

            <label className = { styles.label } htmlFor="color-input">Color Input</label>
            <input className = { styles.input } id="color-input" type="color" />
            <label className = { styles.label } htmlFor="reset-input">Reset Input</label>
            <input className = { styles.input } id="reset-input" type="reset" />

            <label className = { styles.label } htmlFor="date-input">Date Input</label>
            <input className = { styles.input } id="date-input" type="date" />
            <label className = { styles.label } htmlFor="time-input">Time Input</label>
            <input className = { styles.input } id="time-input" type="time" />
            <label className = { styles.label } htmlFor="week-input">Week Input</label>
            <input className = { styles.input } id="week-input" type="week" />
            <label className = { styles.label } htmlFor="month-input">Month Input</label>
            <input className = { styles.input } id="month-input" type="month" />


            <label className = { styles.label } htmlFor="file-input">File Input</label>
            <input className = { styles.input } id="file-input" type="file" />
            ...
            <label className = { styles['form-control'] }>
                <input name="checkbox" type="checkbox" className = { styles['input--checkbox'] }/>
                Checkbox
            </label>

            <label className = { styles['form-control'] }>
                <input name="radio" type="radio" disabled className = { styles['input--radio'] }/>
                Radio
            </label>

            <label className = { styles['form-control'] }>
                <input name="radio" type="radio" className = { styles['input--radio'] } />
                Radio - checked
            </label>
            ...
            <input className = { styles.input } name="submit-input" id="submit-input" type="submit" />
        </form>
    );
};
