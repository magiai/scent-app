  ...
  return (
    <Layout>
      ...
      <main>
        ...
        <br />
        <input name="checkbox-exemple" id="checkbox-exemple" type="checkbox"/>
        <label for="checkbox-exemple">Checkbox exemple</label>
        <br />
        <input name="radio-button-exemple" id="radio-button-exemple" type="radio"/>
        <label for="radio-button-exemple">radio button exemple</label>
        <br />
        <select>
